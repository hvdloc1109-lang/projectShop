...
<div class="row" style="padding-bottom: 30px">
    <div class="col-2">
        <a href="/backend/${list.path}/create" style="float: left" class="btn btn-primary" type="submit">Tạo mới</a>
    </div>
    ...
    <div class="col-2">
        <div class="form-outline">
            <select class="form-select" id="numberPage" onchange="changePage();">
