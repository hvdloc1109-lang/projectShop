    ...
    <f:form action="/backend/product/save" modelAttribute="productDto" method="post" class=" g-3 needs-validation" enctype="multipart/form-data">
        ...
        <div class="row mb-4">
            <div class="col-3">
                ...
                <f:input type="text" class="form-control" readonly="true" path="alias" id="validationCustom08"/>
            </div>
            <div class="col-3">
                <label for="validationCustom14" class="form-label">Tên sản phẩm</label>
                <f:input type="text" class="form-control" readonly="true" path="name" id="validationCustom14"/>
            </div>
            <div class="col-3">
        ...
        <div class="row mb-4">
            ...
            <div class="col-3">
                <f:input type="text" cssStyle="display: none" class="form-control" path="mainImage"/>
                <div id="img-preview"><img width="150px" src="/image-product/${productDto.mainImage}"/></div>
            </div>
        </div>
        <script>
