...
<div class="container-fluid py-5">
    <div class="row px-xl-5">
        ...
        <div class="col-lg-7 pb-5">
            ...
            <h3 class="font-weight-semi-bold mb-4">${products.price}VNĐ</h3>
            ...
            <div class="d-flex align-items-center mb-4 pt-2">
                ...
                <sec:authorize access="isAuthenticated()">
                    <a href="/product/cart" class="btn btn-primary px-3" onclick="order()"><i class="fa fa-shopping-cart mr-1"></i> Thêm vào giỏ hàng</a>
                    <script>
                        function order() {
                            console.log("đặt hàng");
                            var size= $('input[name=size]:checked').val();
                            if (size == undefined) {alert("Vui long chòn size"); return;}
                            var color= $('input[name=color]:checked').val();
                            if (color == undefined) {alert("Vui long chòn màu sắc"); return;}
                ...
                <sec:authorize access="!isAuthenticated()">
                    <a class="btn btn-primary px-3" href="/login"><i class="fa fa-shopping-cart mr-1"></i> Thêm vào giỏ hàng</a>
                </sec:authorize>
...
<%--                                <h6>${p.price}VNĐ</h6><h6 class="text-muted ml-2"><del>${p.price}VNĐ</del></h6>--%>
<%--                            </div>--%>
<%--                        </div>--%>
...
<%--                </c:forEach>--%>
                ...
                <div class="card product-item border-0">
                    ...
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        ...
                        <div class="d-flex justify-content-center">
                            <h6266.000VNĐ</h6><h6 class="text-muted ml-2"><del>266.000VNĐ</del></h6>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-between bg-light border">
                ...
                <div class="card product-item border-0">
                    ...
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        ...
                        <div class="d-flex justify-content-center">
                            <h6>255.000VNĐ</h6><h6 class="text-muted ml-2"><del>255.000VNĐ</del></h6>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
                ...
                <div class="card product-item border-0">
                    ...
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">BLACK EMINENCE TEE</h6>
                            <div class="d-flex justify-content-center">
                            <h6>255.000VNĐ</h6><h6 class="text-muted ml-2"><del>300.000VNĐ</del></h6>
                     </div>
                 </div>
