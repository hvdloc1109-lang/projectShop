...
<div class="container">
    ...
    <br>
    <f:form action="/backend/user/save" modelAttribute="userDto" method="post" class=" g-3 needs-validation" >
        <div class="row mb-4">
            <div class="col-md-4">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3">
                ...
                <f:select class="form-select" path="status" id="validationCustom04" >
            ...
            <div class="col-md-3">
                ...
                <f:select class="form-select" path="role" id="validationCustom14" >
        ...
        <div class="row mb-4">
            <div class="col-6">
                ...
                <f:input type="text" class="form-control" path="phone" id="validationCustom088" />
            </div>
            <div class="col-6">
                <label for="validationCustom087" class="form-label">Ngày sinh</label>
                <f:input type="date" class="form-control" path="date" id="validationCustom087" />
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-12">
                <label for="validationCustom086" class="form-label">Địa chỉ</label>
                <f:input type="text" class="form-control" path="address" id="validationCustom086" />
            </div>
        </div>
