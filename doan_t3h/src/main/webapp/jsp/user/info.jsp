...
<div class="container">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <label for="validationCustom08" class="form-label">Số điện thoại</label>
            <input type="text" readonly="true" value="<sec:authentication property="principal.phone"/>" class="form-control" path="address"
